...
while True:
    ...
    tap_button(btn_0=A, press_time=0.1, wait_time=10)
    ...
    tap_button(btn_1=PLUS, press_time=0.1, wait_time=2.0)
    
    tap_button(dpad=DPAD_DOWN, press_time=0.1, wait_time=1.0)
    
    tap_button(btn_0=A, press_time=0.1, wait_time=1.0)
    
    tap_button(dpad=DPAD_RIGHT, press_time=0.1, wait_time=1.0)
    
    tap_button(btn_0=A, press_time=0.1, wait_time=5.0)
    
    tap_button(btn_0=A, press_time=0.1, wait_time=3.0)
    
    tap_button(btn_0=A, press_time=0.2, wait_time=3.0)
    
    tap_button(btn_0=X, press_time=0.1, wait_time=1.2)
